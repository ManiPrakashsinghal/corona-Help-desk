...
var ShareService = /** @class */ (function () {
    function ShareService(navCtrl) {
        this.navCtrl = navCtrl;
        this.data = {};
    }
    ShareService.prototype.setData = function (key, data) {
        this.data[key] = data;
    };
    ShareService.prototype.getData = function (key) {
        return this.data[key];
    };
    ShareService.prototype.removeData = function (key) {
        delete this.data[key];
    };
    ShareService.prototype.goBack = function () {
        this.navCtrl.pop();
    };
    ShareService.prototype.getList = function () {
    };
